 ...
 * @module fs
 * @description
 * <p>Wraps Node's <code>fs</code> module, but return promises rather than take callbacks.</p>
 * <p>Also implements CommonJS file system API: <a href="http://wiki.commonjs.org/wiki/Filesystem/A">http://wiki.commonjs.org/wiki/Filesystem/A</a>. <em>Not all these APIs are asynchronous!</em></p>
 */
...
var fs = require("fs"),
	...
	convertAsync = require("./promise").convertAsync;
