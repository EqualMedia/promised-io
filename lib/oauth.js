...
// Wrapper for `request` which signs the request
...
Client.prototype.request = function(originalRequest){
	...
	// Ensure host header is set, even thouh `request` doesn't do this automatically.
	...
	// Allow parameters to be defined in object notation, this is *not* part of `request`!
